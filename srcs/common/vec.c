...
void *vec_extract(const vec_t *src, size_t start, size_t end)
{
	...
	if (ptr) {
		(void)memcpy(ptr,
			     ((char *)(src)->_ptr + (src)->_elt_size * (start)),
...
bool vec_push(vec_t *self, const void *e)
{
	...
	(void)memmove(
		((char *)(self)->_ptr + (self)->_elt_size * (self->_nmemb)), e,
		self->_elt_size);
...
void vec_pop(vec_t *self, void *into)
{
	...
	void *ptr = ((char *)(self)->_ptr + (self)->_elt_size * (self->_nmemb));
...
bool vec_insert(vec_t *self, size_t p, void *e)
{
	...
	(void)memmove(((char *)(self)->_ptr + (self)->_elt_size * (p + 1)),
		      ((char *)(self)->_ptr + (self)->_elt_size * (p)),
		      self->_nmemb * self->_elt_size - p * self->_elt_size);

skip:
	(void)memcpy(((char *)(self)->_ptr + (self)->_elt_size * (p)), e,
		     self->_elt_size);
	++self->_nmemb;
...
vec_t *vec_dup(vec_t *self)
{
	...
	vec_t *v = vec_create(self->_elt_size, self->_nmemb, self->_free);
	if (!v) {
		return (NULL);
	}
...
bool vec_inject(vec_t *self, size_t p, const void *src, size_t n)
{
	...
	(void)memmove(((char *)(self)->_ptr + (self)->_elt_size * (p + n)),
		      ((char *)(self)->_ptr + (self)->_elt_size * (p)),
		      self->_elt_size * (self->_nmemb - p));

skip_moving:
	(void)memmove(((char *)(self)->_ptr + (self)->_elt_size * (p)), src,
		      self->_elt_size * n);
...
bool vec_append(vec_t *self, const void *src, size_t n)
{
	...
	(void)__builtin_memmove(
		((char *)(self)->_ptr + (self)->_elt_size * (self->_nmemb)),
		src, self->_elt_size * n);
...
void vec_evict(vec_t *self, size_t p)
{
	...
	if (self->_free) {
		self->_free(((char *)(self)->_ptr + (self)->_elt_size * (p)));
	}
...
void vec_wipe(vec_t *self, size_t start, size_t end)
{
	...
	(void)memmove(((char *)(self)->_ptr + (self)->_elt_size * (start)),
